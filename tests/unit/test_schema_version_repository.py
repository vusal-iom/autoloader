...
class TestSchemaVersionRepository:
    ...
    def test_get_latest_version(self, test_local_db):
    ...
    def test_get_latest_version_no_versions(self, test_local_db):
    ...
    def test_get_all_versions(self, test_local_db):
    ...
    def test_get_version_by_number(self, test_local_db):
    ...
    def test_get_version_by_number_not_found(self, test_local_db):
    ...
    def test_get_next_version_number_first_version(self, test_local_db):
    ...
    def test_get_next_version_number_increments(self, test_local_db):
    ...
    def test_multiple_ingestions_isolated(self, test_local_db):
    ...
    def test_affected_files_optional(self, test_local_db):
    ...
    def test_changes_stored_correctly(self, test_local_db):
